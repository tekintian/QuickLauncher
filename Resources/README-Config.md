...
Then drag the `QuickLauncher` icon to the toolbar:
...
1. Open the QuickLauncher app.
2. Navigate to `System Preferences` -> `Extensions` -> `Finder Extensions`.
3. Check the checkbox next to `QuickLauncherFinderExtension`, as shown below:
...
<br><code>tccutil reset AppleEvents cn.tekin.app.QuickLauncher</code><br>
</details>
...
<details><summary>QuickLauncher doesn't work as I expected</summary><br>
<p>QuickLauncher works as the following order:</p>
<ul>
